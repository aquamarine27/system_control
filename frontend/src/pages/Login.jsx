          ...
          <form onSubmit={handleSubmit} className="login-form">
            <div className="login-input-wrapper">
              <input
                ...
                onBlur={() => {
                  if (!loginInput) setLoginFocused(false);
                  setErrors({ ...errors, login: validateLogin(loginInput) });
                }}
                className={errors.login ? "input-error" : ""}
                required
              />
              <span className={`login-placeholder ${loginFocused || loginInput ? "login-placeholder-active" : ""} ${errors.login ? "error-placeholder" : ""}`}>
                Login
              </span>
